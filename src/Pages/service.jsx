      ...
      >
        ...
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-3">
          {services.map((service, index) => (
            <motion.div
              ...
              className="group bg-white text-gray-800 p-5 md:p-12 lg:p-12 rounded-xl shadow-2xl transition-all duration-200 hover:shadow-[0_2px_35px_blue] hover:scale-205 hover:border-blue-400 border border-transparent"
            >
        ...
        <div className="mt-20 px-4 sm:px-8">
          <motion.div
            ...
            className="group p-5 md:p-12 lg:p-12 bg-white   text-center shadow-2xl transition-all duration-300 hover:shadow-[0_2px_35px_blue] hover:scale-[1.02] hover:border-blue-500 border border-transparent"
          >
            <h2 className="text-justify text-2xl sm:text-3xl md:text-4xl font-extrabold text-gray-900 leading-snug transition-colors duration-300 group-hover:text-blue-700">
              Have an IT Solution Need? <br className="hidden sm:block" /> Look
              No Further — Emmark Tech Has You Covered.
            </h2>
