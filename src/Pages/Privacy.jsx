      ...
      <div className="bg-gradient-to-r from-black via-blue-600 to-blue-500">
        <div className="max-w-5xl mx-auto py-16 px-6 text-white">
          ...
          <p className="mb-6 text-lg">
            At <strong>Emmark-Tech</strong>, we are committed to protecting your
          ...
          <section>
            ...
            <p className="mt-2 font-medium">Email: helpdesk@emmarktech.com</p>
            <p className="font-medium">Phone: +234 813 016 9810</p>
          </section>
        </div>
      </div>{" "}
      <Footer />
